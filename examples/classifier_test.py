...
# GNU Radio version: 3.8tech-preview-326-g8ecdef41
...
class classifier_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self.video_sdl_sink_0 = video_sdl.sink_uc(0, 28, 28, 0, 640, 480)
        self.source = blocks.file_source(gr.sizeof_char*1, '', True, 0, 0)
        ...
        self.dnn_dnn_onnx_python_0 = dnn.dnn_onnx_python('')
        ...
        self.connect((self.blocks_throttle_0, 0), (self.video_sdl_sink_0, 0))
